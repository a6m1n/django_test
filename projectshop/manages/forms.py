...
class OrderForm(forms.Form):
    ...
    date_close_order = forms.DateField(input_formats=['%d/%m/%Y'], required=False,)
    ...
    date_close_order.widget.attrs.update({"placeholder": "format: dd.mm.YYYY.", "class": "form-control"})
